...
const handleSubmit = async (e) => {
    ...
    if (!userID) {
        ...
        try {
            const response = await axios.post("https://app.callmineon.com/manager/review/create", {userID, name, feedback});
...
const handleDeleteReviewClick = async () => {
    ...
    try {
        const response = await axios.delete("https://app.callmineon.com/manager/review/delete", { data: {id: selectedReviewID, name: deleteReview} });
...
function ReviewEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put("https://app.callmineon.com/manager/review/edit", {
                id: reviewID,
                name: newName,
