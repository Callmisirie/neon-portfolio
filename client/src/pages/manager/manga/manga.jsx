...
const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.post("https://app.callmineon.com/manager/manga/create/manga", formData, {
            headers: {
...
const handleChapterSubmit = async (e) => {
    ...
    try {
        const response = await axios.post("https://app.callmineon.com/manager/manga/create/manga/chapter", formData, {headers: {
            "Content-Type": "multipart/form-data"
        }});
...
useEffect(()=> {
    const fetchManga = async () => {
        try {
            const MangaResponse = await axios.get("https://app.callmineon.com/manga");
            setMangas(MangaResponse.data);
            const mangaContentsResponse = await axios.get("https://app.callmineon.com/chapterContent");
...
const handleDeleteMangaClick = async () => {
    ...
    try {
        const response = await axios.delete("https://app.callmineon.com/manager/manga/delete/manga", { data: {id: selectedMangaID, name: deleteMangaName} });
        const {message, color} = response.data;
        setDeleteMangaName("");
...
const handleDeleteChapterClick = async () => {
    ...
    try {
        const response = await axios.delete("https://app.callmineon.com/manager/manga/delete/manga/chapter",{data: {mangaID: selectedMangaID, chapterID: selectedChapterID, title: deleteChapterTitle}});
        const {message, color} = response.data;
...
function MangaEdit() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put("https://app.callmineon.com/manager/manga/edit/manga", formData, {
                headers: {
                    "Content-Type": "multipart/form-data"
                }
            });
    ...
    const handleChapterSubmit = async (e) => {
        ...
        try {
            const response = await axios.put("https://app.callmineon.com/manager/manga/edit/manga/chapter", formData, {
                headers: {
                "Content-Type": "multipart/form-data"
                }
            });
